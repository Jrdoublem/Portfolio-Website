export const profile = {
  ...
  portrait: '/images/profile.webp', resume: '/resume/Jirasudanee_Resume.pdf',
...
export const projects = [
  { id: 'quakelink', number: '01', title: 'QuakeLink', category: 'IoT · Research', year: '2025–2026', image: '/images/quakelink.webp', imageAlt: 'QuakeLink team presenting their project at the I-New Gen exhibition', featured: true,
  ...
  { id: 'energy', number: '02', title: 'Energy Audit System', category: 'Frontend · Industry', year: '2026', image: '/images/energy-audit.webp', imageAlt: 'Industry project team presenting the Energy Audit System at SID-EN',
  ...
  { id: 'motor', number: '03', title: 'Intelligent Motor Condition Monitoring Platform', category: 'AI · Industrial IoT', year: '2026', image: '/images/motor-monitoring.webp', imageAlt: 'SITTUI team receiving the Best Project award at Industrial IoT Tech-Creator Challenges',
  ...
  { id: 'silvora', number: '04', title: 'AR Silk Road Game@AYUTTHAYA', category: 'AR · Cultural innovation', year: '2025', image: '/images/silvora.webp', imageAlt: 'Silvora project team during their Ayutthaya field visit',
...
export const activities = [
  { title: 'Leading the next generation', category: 'AIoT Club · 2025', image: '/images/aiot-club.webp', alt: 'Jirasudanee teaching an introductory programming session', text: 'Planned and taught introductory programming sessions for first-year students as AIoT Club president.' },
  { title: 'Taking research to the stage', category: 'EENET · May 2026', image: '/images/research.webp', alt: 'Jirasudanee presenting QuakeLink research at EENET', text: 'Presented co-authored research on a real-time earthquake monitoring and mobile alert network.' },
  { title: 'Connecting the AIoT community', category: 'AIoT Foresight & Transformation · March 2026', image: '/images/aiot-event.webp', alt: 'Presenters at the AIoT Foresight and Transformation event', text: 'Served as emcee at an event marking academic cooperation between SPU and the Thai IoT Association.' },
];
